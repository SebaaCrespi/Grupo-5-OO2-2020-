...
import com.objetosdos.spring.entities.*;
...
public class Venta {
	...
	/*@Id
	Identity
	Se basa en una columna de base de datos con incremento automático 
	y permite que la base de datos genere un nuevo valor con cada 
